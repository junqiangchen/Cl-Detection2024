...
def inferenceUnetVnet2dlandmarkerbrain(sliceimage, vnetfocal_loss, unetfocal_loss, unetL2):
    # step1 load model
...
class Cldetection_alg_2024(DetectionAlgorithm):
    ...
    def __init__(self):
        ...
        self.vnetfocal_loss = "vnetfocal_lossbest.pth"
        self.unetfocal_loss = "BinaryVNet2dModel.pth"
        self.unetL2 = "unetL2.pth"
    ...
    def predict(self, *, input_image: SimpleITK.Image, file_name: str):
        ...
        predict_landmarks = inferenceUnetVnet2dlandmarkerbrain(image_array, self.vnetfocal_loss, self.unetfocal_loss,
                                                               self.unetL2)
        #
        # # Predict | 预测
        # with torch.no_grad():
