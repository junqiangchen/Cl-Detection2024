...
import numpy as np
from dataprocess.utils import ConvertitkTrunctedValue
...
class MutilResNet3dModel(object):
    ...
    def __init__(self, image_depth, image_height, image_width, image_channel, numclass, batch_size,
                 loss_name='MutilFocalLoss', inference=False, model_path=None, amp=True, accum_iter=1, num_cpu=8,
                 use_cuda=True):
        self.batch_size = batch_size
        self.loss_name = loss_name
        self.accuracyname = 'accu'
    ...
    def inference(self, image):
        ...
        imageresize = image
        # imageresize = ConvertitkTrunctedValue(image, 600, -1000, 'meanstd')
