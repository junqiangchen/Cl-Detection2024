import torch
from networks.Unet2d import UNet2d, UNet2dlandmarkregression
...
from .dataset import datasetModelSegwithopencv, datasetModelSegwithnpy, datasetModelSegwithnpymutil, \
    datasetModelRegressionwithnpy, datasetModelRegressionwithopencv, datasetModellandmarkwithnpy
...
class UNet2dlandmarkdetectionModel(object):
    """
    Unet2d with binary class,should rewrite the dataset class and inference fucntion
    """
    ...
    def __init__(self, image_height, image_width, image_channel, numclass, batch_size, loss_name='L1',
        ...
        self.model = UNet2dlandmarkregression(self.image_channel, self.numclass)
        self.model.to(device=self.device)
    ...
    def trainprocess(self, trainimage, trainmask, validationimage, validationmask, model_dir, epochs=50, lr=1e-3,
        ...
        print("[INFO] training the network...")
        Path(model_dir).mkdir(parents=True, exist_ok=True)
        MODEL_PATH = os.path.join(model_dir, "BinaryUNet2dModel.pth")
        MODEL_PATH_best = os.path.join(model_dir, "BinaryUNet2dModelbest.pth")
        print(self.model)
        self.model_dir = model_dir
        self.showpixelvalue = 255.
        self.showwind = showwind
    ...
    def get_landmarks(self, heatmaps_array):
